...
export const AdminRows = ({ admin, months }: AdminRowsProps) => (
  <>
    <tr className="text-[#A6B1B9] font-semibold text-left font-['Roboto'] text-sm">
      <td rowSpan={2} className="border border-gray-300 px-4 py-3 font-semibold bg-gray-50 text-[#4F669D]" >
        {admin.adminName}
      </td>
      ...
      {months.map(m => {
        ...
        return (
          <Fragment key={m}>
            ...
            <TableCell value={month.fact.income} isPrice className="border-r border-t border-gray-300" />
          </Fragment>
        );
      })}
